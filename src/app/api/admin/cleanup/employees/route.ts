...
export async function DELETE(request: NextRequest) {
  try {
    // Orden de eliminación para respetar las foreign keys de empleados
    const tablesToClean = [
      'employee_sessions',
      'employees'
    ];
    ...
    console.error('Error durante la limpieza de empleados:', error);
    return NextResponse.json(
      { 
        success: false, 
        error: 'Error interno del servidor durante la limpieza de empleados',
