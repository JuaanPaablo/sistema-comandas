...
export default function CocinaGeneralPage() {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Cargando comandas...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">🍳 COCINA - Vista General</h1>
              <p className="text-gray-600">Gestión de todas las comandas en tiempo real</p>
            </div>
          </div>
